...
This data set is collected from people that have suspected heart issues in Long Beach, Hungary, Cleveland and Switzerland. A total of 920 patients and 14 variables with the location were used.
...
## Usage
Make sure that in an R session, the project files are all cloned and every requirement is installed. Run the 00_doit.R script found under the "R" folder. This will run all necessary scripts to make the raw data into png files and generate the presentation document.
