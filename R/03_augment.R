...
Data_aug <- Data %>%
  mutate(Location_num = case_when(Location == "Cleveland" ~ 0, 
         ...
         Diagnosis_of_disease = 
           case_when(diagnosis_of_heart_disease == 0 ~ "Not present",
         ...
         Resting_electrocardiographic_cat = 
           case_when(Resting_electrocardiographic == 0 ~ "Normal",
                     Resting_electrocardiographic == 1 ~ "ST-T abnormality", 
                     Resting_electrocardiographic == 2 ~ "LV hypertrophy"),
         
         Exercise_induced_angina_cat = 
           case_when(Exercise_induced_angina == 1 ~ "Present",
                     Exercise_induced_angina == 0 ~ "Not present"),
         
         slope_of_ST_cat = case_when(
           The_slope_of_the_peak_exercise_ST_segment == 1 ~"upsloping",
         ...
         Diagnosis_of_disease_No = 
           case_when(diagnosis_of_heart_disease == 0 ~ 0,
