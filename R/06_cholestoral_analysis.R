...
Data <- Data_selection(data = Data_aug,var = c("Location",
                                               "Serum_cholestoral",
                                               "Diagnosis_of_disease"), 
                       rm_na = TRUE, 
                       rm_na_from = c("Serum_cholestoral")) 
...
Location_cholesterol_plot <- Location_cholesterol_plot + 
  annotate("text", x = 550, y = 3, label = mean_string)
Location_disease_plot <- Location_disease_plot + 
  annotate("text", x = 150, y = 3, label = diagnosis_present_string)
...
ggsave(Location_plot, 
       filename="/cloud/project/results/06_Location_plot.png", 
