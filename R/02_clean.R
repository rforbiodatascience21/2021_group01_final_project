...
# Wrangle data ------------------------------------------------------------
Data <- Cleveland %>%
  full_join(Hungarian, by = c("Age", "Sex", "Chest_pain_type", 
                              ...
                              "Location")) %>%
  full_join(Switzerland, by = c("Age", "Sex", "Chest_pain_type", 
                                "Resting_blood_pressure",
                                "Serum_cholestoral", 
                                "Fasting_blood_sugar",
                                "Resting_electrocardiographic", 
                                ...
                                "diagnosis_of_heart_disease", 
                                "Location")) %>%
  full_join(Long_Beach, by = c("Age", "Sex", "Chest_pain_type", 
                               "Resting_blood_pressure",
                               "Serum_cholestoral", 
                               "Fasting_blood_sugar",
                               "Resting_electrocardiographic", 
...
Data <- Data %>% 
  mutate(Serum_cholestoral = 
           case_when(Serum_cholestoral > 0 ~ Serum_cholestoral),
         Resting_blood_pressure = 
           case_when(Resting_blood_pressure > 0 ~ Resting_blood_pressure))
